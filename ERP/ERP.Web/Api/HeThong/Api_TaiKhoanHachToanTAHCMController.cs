...
{
    public class Api_TaiKhoanHachToanTAHCMController : ApiController
    {
        private HOPLONG_DATABASEEntities db = new HOPLONG_DATABASEEntities();

        // GET: api/Api_TaiKhoanHachToanTAHCM
        ...
        // GET: api/Api_TaiKhoanHachToanTAHCM/5
        ...
        // PUT: api/Api_TaiKhoanHachToanTAHCM/5
        ...
        // POST: api/Api_TaiKhoanHachToanTAHCM
        [ResponseType(typeof(DM_TAI_KHOAN_HACH_TOAN))]
        ...
        // DELETE: api/Api_TaiKhoanHachToanTAHCM/5
        [ResponseType(typeof(DM_TAI_KHOAN_HACH_TOAN))]
