...
{
    public class Api_PhongbanTAHCMController : ApiController
    {
        private HOPLONG_DATABASEEntities db = new HOPLONG_DATABASEEntities();

        // GET: api/Api_PhongbanTAHCM
        public List<CCTC_PHONG_BAN> GetCCTC_PHONG_BAN()
        {
            var vData = db.CCTC_PHONG_BAN.Where(x => x.MA_CONG_TY == "TAHCM");
        ...
        // DELETE: api/Api_PhongbanTAHCM/5
        [ResponseType(typeof(CCTC_PHONG_BAN))]
